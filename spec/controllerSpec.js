...
describe("Controller", () => {
  ...
  describe('enableEditor', () => {
    const mockWin = new JSDOM(`<!DOCTYPE html><p id='flickerdocs'></p><p id="peerId"></p><p class='video-modal'></p><p class="copy-container"></p>`).window;
    const mockDoc = mockWin.document;
    const controller = new Controller(targetPeerId, host, mockPeer, mockBroadcast, mockEditor, mockWin.document, mockWin);

    it('removes the hide class from the editor element', () => {
      mockDoc.getElementById('flickerdocs').classList.add('hide');
      controller.enableEditor(mockDoc);
      expect(mockDoc.getElementById('flickerdocs').classList.length).toEqual(0);
    });
  });
  ...
  describe("addToListOfPeers", () => {
    ...
    beforeEach(() => {
      mockWin = new JSDOM(`<!DOCTYPE html><p id='flickerdocs'></p><p id="peerId"></p><p class='video-modal'></p><p class="copy-container"></p>`).window;
      mockDoc = mockWin.document;
      controller = new Controller(targetPeerId, host, mockPeer, mockBroadcast, mockEditor, mockDoc, mockWin);
  ...
  describe("handleSync", () => {
    const mockWin = new JSDOM(`<!DOCTYPE html><p id='flickerdocs'></p><p class='minimize'></p><p class='exit'></p><p class='video-bar'></p><p id="peerId"></p><p class='video-modal'><video /></p><p class="copy-container"></p>`).window;
    mockWin.history.pushState = function(one, two, three) {};
    const mockDoc = mockWin.document;
    const controller = new Controller(targetPeerId, host, mockPeer, mockBroadcast, mockEditor, mockDoc, mockWin);
    controller.broadcast.peer = mockPeer;
  ...
  describe('syncCompleted', () => {
    let mockWin, mockDoc, controller;
    beforeEach(() => {
      mockWin = new JSDOM(`<!DOCTYPE html><p id='flickerdocs'></p><p class='minimize'></p><p class='exit'></p><p class='video-bar'></p><p id="peerId"></p><p class='video-modal'><video /></p><p class="copy-container"></p>`).window;
      mockWin.history.pushState = function(one, two, three) {};
      mockDoc = mockWin.document;
      controller = new Controller(targetPeerId, host, mockPeer, mockBroadcast, mockEditor, mockDoc, mockWin);
      controller.broadcast.peer = mockPeer;
